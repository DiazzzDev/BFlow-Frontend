    ...
    return (
        <Combobox as="div" value={selectedItem} onChange={(item : T | null) => {
            ...
            <div className="relative mt-2">
                <ComboboxInput
                    id={idSelect}
                    className="w-full rounded-lg border border-light-10 bg-surface px-4 py-2 text-sm text-light shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-primary"
