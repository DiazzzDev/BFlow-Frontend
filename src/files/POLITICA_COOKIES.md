...
Las cookies son pequeños archivos de datos almacenados en su dispositivo cuando utiliza un sitio web o aplicación. Las cookies son típicamente utilizadas por las organizaciones para mejorar la funcionalidad, seguridad y experiencia del usuario.
...
## Lo que BFlow NO utiliza cookies para

Para garantizar su privacidad y transparencia, aclaramos explícitamente lo que **no** hacemos:
...
## ¿Tengo que aceptar estas cookies?
...
## Controles de cookies del navegador

La mayoría de navegadores web le permiten controlar cómo se almacenan las cookies. Si desea administrar la configuración de cookies de su navegador, consulte la documentación de ayuda de su navegador:

- [Ayuda de Chrome](https://support.google.com/chrome)
- [Ayuda de Safari](https://support.apple.com/es-es)
- [Ayuda de Firefox](https://support.mozilla.org/es-ES/products/firefox)
- [Ayuda de Microsoft Edge](https://support.microsoft.com/es-es/edge)

**Importante:** Desactivar las cookies en su navegador le impedirá usar BFlow, ya que nuestras cookies de autenticación son esenciales.
...
Podemos actualizar esta Política de Cookies de vez en cuando para reflejar cambios en nuestra tecnología, prácticas de seguridad o regulaciones aplicables. Lo notificaremos de cualquier cambio material actualizando la fecha en la parte superior de esta política. Le recomendamos que revise esta política periódicamente para mantenerse informado.
...
Estamos comprometidos con la transparencia y estaremos encantados de abordar sus inquietudes de privacidad.
