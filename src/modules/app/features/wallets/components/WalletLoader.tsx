...
export const WalletLoader = () => (
    <div className="flex flex-col items-center justify-center py-12 gap-6 col-span-full">
        ...
        <div className="flex flex-col items-center gap-2">
            <p className="text-sm font-medium text-foreground">Cargando billeteras</p>
            <div className="flex gap-1.5">
                ...
                <span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse [animation-delay:800ms]" />
            </div>
        </div>
    </div>
)
