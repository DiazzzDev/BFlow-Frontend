        ...
        >
            ...
            <div className="flex gap-4 flex-wrap">
                ...
                <div className="flex flex-col gap-1 flex-1 min-w-[140px]">
                    ...
                    />
                    {errors.initialValue && (
                        <span className="text-danger text-xs">{errors.initialValue.message}</span>
                    )}
                </div>
            </div>
            ...
            <button
                type="submit"
                disabled={isSubmitting}
                className="w-full h-11 rounded-lg bg-primary text-primary-foreground font-medium hover:bg-primary-dark disabled:opacity-50 cursor-pointer mt-2"
            >
