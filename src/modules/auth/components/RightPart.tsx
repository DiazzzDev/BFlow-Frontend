            ...
            <div className="w-full max-w-md">
                ...
                <div className="mt-8 space-y-6 mb-5">
                    <Button onClick={
                        ...
                        } variant="outline" className="h-12 w-full rounded-xl border-border bg-bg-card text-text-primary hover:bg-bg-hover hover:text-text-primary" disabled={isLoading}>
