    ...
    return (
        <section className="flex flex-1 items-center justify-center bg-background px-6 py-10 lg:px-14">
            <div className="w-full max-w-md">
                ...
                <div className="mt-8 space-y-6 mb-5">
                    <Button onClick={handleGoogleLogin} variant="outline" className="h-12 w-full rounded-xl border-border bg-bg-card text-text-primary hover:bg-bg-hover hover:text-text-primary" disabled={isLoading}>
