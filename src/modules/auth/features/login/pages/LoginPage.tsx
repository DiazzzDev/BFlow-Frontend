...
export const LoginPage = () => {
	...
	return (
		<main className='w-full h-screen flex gap-4'>
			...
			<RightPart Body={<LoginForm onSubmitLogin={async () => {}} isLoading={false} />} isLoading={false} separatorText="O inicia sesión con tu email" title="Bienvenido de vuelta" subtitle="Ingresa tus credenciales para continuar" />
		</main>
	)
}
