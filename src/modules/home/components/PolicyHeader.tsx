    ...
    return (
        <div className="border-b border-[var(--border-subtle)] px-20 py-16">
            <div className="flex justify-between items-start mb-4">
                <div>
                    <p className="text-xs tracking-widest uppercase text-[var(--tertiary)] mb-3">{header.badge}</p>
                ...
                <select className="bg-[var(--card)] border border-[var(--border-subtle)] rounded px-3 py-2 text-sm" onChange={(e) => setLocale(e.target.value)} value={locale}>
