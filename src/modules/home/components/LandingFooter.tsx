            ...
            <div className="grid grid-cols-[2fr_1fr_1fr_1fr] gap-10 mb-12">
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <p className="text-sm text-[var(--text-muted)] hover:text-white transition-colors">Blog</p>
                        <p className="text-sm text-[var(--text-muted)] hover:text-white transition-colors">Contacto</p>
                    </div>
                </div>
